  ...
  return (
    <div className="wrapper">
      ...
      <div className="main-brands">
        <img className="logo_brands " src={versace} />
        <img className="logo_brands " src={zara} />
        <img className="logo_brands " src={gucci} />
        <img className="logo_brands " src={prada} />
        <img className="logo_brands " src={calvin} />
      </div>
    </div>
  );
};
